#!/usr/bin/env python3
"""
Ethiopian Salary Prediction — Training Script
=============================================

End-to-end ML pipeline: loads data, trains simple and multiple regression models,
evaluates performance, and saves the best model artifact.

Usage:
    python src/train.py

Outputs:
    models/best_ethiopian_salary_model.pkl
"""
...
DATA_PATH = PROJECT_ROOT / "data" / "raw" / "ethiopia_salary_data.csv"
MODEL_OUTPUT_PATH = PROJECT_ROOT / "models" / "best_ethiopian_salary_model.pkl"
...
def save_model(model, model_name):
    ...
    filename = str(MODEL_OUTPUT_PATH)
